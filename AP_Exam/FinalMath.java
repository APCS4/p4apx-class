    ...
    */
    ...
    {    	
		...
		case 1:
	    	...
	    	float number1 = rand.nextFloat() * multiplier[rand.nextInt(multiplier.length)];
	    	Integer index1 = rand.nextInt(datatype.length);
	    	//setupQuestion(datatype[index1], value1);

	    	//randomize second number
	    	int number2 = rand.nextInt() * multiplier[rand.nextInt(multiplier.length)];
	    	Integer index2 = rand.nextInt(datatype.length);
